...
public class HomePage extends BasePage {
	// initializion of all webelement 
...
//constructor
	...
	public void userLogin(String sUserEmailId, String sUserPassword) throws Exception {
		...
		mouseControl.moveToElement(customerLogin); // go to customer login
		elementControl.clickElement(userLogin); //userlogin click

		Thread.sleep(2000);
		elementControl.setText(userEmailId, sUserEmailId);
		elementControl.setText(userPassword, sUserPassword);
		elementControl.clickElement(loginButton);//click
	}
